...
parser.add_argument("--data-dir", default='D:/bus/deepsort', type=str)
...
# data loading
root = args.data_dir
train_dir = os.path.join(root, "D:/bus/deepsort/train")
test_dir = os.path.join(root, "D:/bus/deepsort/test")
